...
<h1 style="font-size: 32px; margin-bottom: 18px;">High-Level Architecture</h1>
<div style="--slide-fs:19.2px; --slide-lh:1.30; font-size:19.2px; line-height:1.30;" markdown="1">
...
<div class="pad-col hero-copy" style="justify-content: center; align-items: flex-start; padding-bottom: 0;">
  <h1 style="margin-bottom: 20px; font-size: 50px; margin-bottom: 20px;">Scaled Dot-Product Attention</h1>
  <div style="opacity: 0.9; --slide-fs:24.5px; --slide-lh:1.26; font-size:24.5px; line-height:1.26;" markdown="1">
...
<div class="pad-col" style="justify-content: center; align-items: center; background: rgba(255,255,255,0.05); padding: 104px 48px 34px 48px;">
